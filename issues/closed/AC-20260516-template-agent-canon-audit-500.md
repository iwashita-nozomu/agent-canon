...
source: user
severity: S1
evidence: user-supplied audit artifact archived locally as parent reports/template_agent_canon_audit_500_issues.md; tracked coverage ledger in ../../documents/agent-canon/template-agent-canon-audit-resolution.md
github_issue: https://github.com/iwashita-nozomu/agent-canon/issues/252
affected_surfaces: README.md, QUICK_START.md, Makefile, ROOT_AGENTS.md, agents/canonical/CODEX_WORKFLOW.md, agents/skills/start-repository.md, agents/skills/catalog.yaml, documents/runtime/runtime-profiles-and-check-matrix.md, documents/agent-canon/template-agent-canon-audit-resolution.md, documents/runtime/SHARED_RUNTIME_SURFACES.md, documents/runtime/shared-runtime-surfaces.toml, documents/tools/README.md, tools/sync_agent_canon.sh
edit_scope: documents/runtime/runtime-profiles-and-check-matrix.md, documents/agent-canon/template-agent-canon-audit-resolution.md, README.md, ROOT_AGENTS.md, agents/canonical/CODEX_WORKFLOW.md, agents/skills/start-repository.md, agents/skills/catalog.yaml, documents/runtime/SHARED_RUNTIME_SURFACES.md, documents/runtime/shared-runtime-surfaces.toml, documents/tools/README.md, tools/catalog.yaml, tools/sync_agent_canon.sh, parent README.md, parent QUICK_START.md, parent Makefile, parent documents/README.md
...
`documents/agent-canon/template-agent-canon-audit-resolution.md` maps every audit ID range
