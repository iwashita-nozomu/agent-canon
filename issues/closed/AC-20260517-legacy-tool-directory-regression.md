...
affected_surfaces: tools/legacy/jax_solver_util/oop_check_support, documents/tools/repo-local-tool-imports.md, tools/README.md, tools/agent_tools/tool_drift.py, .github/workflows/agent-canon-static-gates.yml
edit_scope: tools/legacy/jax_solver_util/oop_check_support, issues/closed/AC-20260517-legacy-tool-directory-regression.md, documents/tools/repo-local-tool-imports.md, tools/README.md, tools/agent_tools/tool_drift.py, .github/workflows/agent-canon-static-gates.yml, tools/ci/check_github_workflows.py, .github/PULL_REQUEST_TEMPLATE.md, agents/workflows/agent-canon-pr-workflow.md
...
in `documents/tools/repo-local-tool-imports.md`, and current OOP checking lives under
