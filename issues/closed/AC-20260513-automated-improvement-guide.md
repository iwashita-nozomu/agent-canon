...
affected_surfaces: .github/workflows/agent-improvement-guide.yml, tools/agent_tools/generate_agent_improvement_guide.py, documents/runtime/runtime-log-archive.md, agents/workflows/agent-canon-pr-workflow.md, tools/README.md, tools/catalog.yaml
edit_scope: .github/workflows/agent-improvement-guide.yml, tools/agent_tools/generate_agent_improvement_guide.py, tests/agent_tools/test_generate_agent_improvement_guide.py, documents/runtime/runtime-log-archive.md, tools/README.md, tools/catalog.yaml, tools/ci/check_github_workflows.py, tests/tools/test_check_github_workflows.py
