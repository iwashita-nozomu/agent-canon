...
downstream design ../../agents/evals/results/hook-runs/README.md documents hook-run result semantics.
@dependency-end
-->
...
affected_surfaces: .codex/hooks/oop_readability_guard.py, .codex/hooks.json, tests/agent_tools/test_codex_hooks.py, agents/evals/results/hook-runs/README.md
