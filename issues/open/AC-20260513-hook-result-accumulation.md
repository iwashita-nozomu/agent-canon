...
affected_surfaces: .codex/hooks/oop_readability_guard.py, .codex/hooks/skill_usage_logger.py, .codex/hooks/hook_event_log.py, agents/evals/results/hook-runs/README.md, tools/agent_tools/generate_agent_improvement_guide.py
