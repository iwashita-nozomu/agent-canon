...
# upstream implementation ../../code/oop/python/readability.py emits OOP readability evidence reports
# upstream implementation ../../code/oop/shared/readability_core.py emits scanned_paths and SOLID counts
