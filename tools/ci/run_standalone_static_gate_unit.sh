...
PY
    ...
    (
      ...
      AGENT_CANON_BRANCH_WORKTREE_REASON="PR 670 disposable source publication replay" \
    ...
    (
      ...
      AGENT_CANON_BRANCH_WORKTREE_AUTHORITY=agent_canon_workflow \
      AGENT_CANON_BRANCH_WORKTREE_REASON="PR 670 fresh recurse-submodules parent replay" \
      AGENT_CANON_DESTRUCTIVE_GIT_AUTHORITY=explicit_user_approval \
