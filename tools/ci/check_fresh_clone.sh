...
for path in AGENTS.md agents .agents .codex/config.toml .codex/hooks.json .codex/hooks/mcp_session_context.sh mcp/repo_mcp_server.sh agents/workflows/README.md agents/workflows/paper-writing-workflow.md; do
  if [ ! -e "${path}" ]; then
