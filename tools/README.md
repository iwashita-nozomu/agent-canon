...
- `agent_tools/`
  ...
  - `operational_ir_to_lean.py` は `agent-canon.thin-operational-ir.v2` と C++ source wrapper などの envelope から、StableHLO / backend 非依存の Lean evidence definitions を生成します。
