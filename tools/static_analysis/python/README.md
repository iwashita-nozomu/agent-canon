...
upstream implementation ../../agent_tools/analyze_oop_readability.py scores OOP readability
@dependency-end
-->
...
python3 tools/agent_tools/analyze_oop_readability.py --format markdown python tools tests
```
