...
echo "NEXT_ACTION=do not create a branch worktree; bootstrap the run with tools/runtime/lifecycle/bootstrap_agent_run.py and serialize colliding writers in the current checkout" >&2
exit 2
