...
REQUIREMENTS: tuple[EvidenceRequirement, ...] = (
    ...
    EvidenceRequirement(
        ...
        "_kkt_run_minres",
        "preconditioner",
        r"make_block_diagonal\(h_inv_approx,\s*s_inv_approx",
    ),
    EvidenceRequirement(
        "K5",
    ...
    EvidenceRequirement(
        ...
        "_kkt_run_minres",
        "solver_answer",
        r"solver_algorithm\(minres\.Problem\(Mv=kkt_operator,\s*rhs=rhs\)",
    ),
    EvidenceRequirement(
        "R1",
    ...
    EvidenceRequirement(
        ...
        "_minres_transformed_system",
        "solve_mv",
        r"minv_sqrt.*problem\.Mv.*minv_sqrt",
    ),
    EvidenceRequirement(
        "M4",
