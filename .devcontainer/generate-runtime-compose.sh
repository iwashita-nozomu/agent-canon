...
# responsibility Renders shared devcontainer compose from repo-local Docker pack and the selected runtime identity.
...
# upstream environment rootless/devcontainer.json rootless-root identity selector
# @dependency-end
