...
# responsibility Runs image verification and container runtime readback before the optional derived-repository hook and propagates either stage's exit status.
...
# downstream implementation ./post-create.sh executes read-only image verification and runtime readback
