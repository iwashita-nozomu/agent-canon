...
class CodexHooksTest(unittest.TestCase):
    ...
    def test_hooks_json_wires_mcp_context_hook(self) -> None:
        ...
        self.assertTrue(any("AGENT_CANON_OOP_HOOK_MODE=diff" in command for command in post_tool_commands))
        ...
        self.assertTrue(any("AGENT_CANON_OOP_HOOK_MODE=diff" in command for command in stop_commands))
