...
- [canonical/README.md](/workspace/vendor/agent-canon/agents/canonical/README.md)
  - 共通レイアウトと正本の置き場
- [agents_config.json](/workspace/vendor/agent-canon/agents/agents_config.json)
  - チーム定義と write policy
- [TASK_WORKFLOWS.md](/workspace/vendor/agent-canon/agents/TASK_WORKFLOWS.md)
  - workflow family と task 選択
- [workflows/README.md](/workspace/vendor/agent-canon/agents/workflows/README.md)
  - workflow canon の入口
- [COMMUNICATION_PROTOCOL.md](/workspace/vendor/agent-canon/agents/COMMUNICATION_PROTOCOL.md)
  - handoff / review / escalation の正本
- [task_catalog.yaml](/workspace/vendor/agent-canon/agents/task_catalog.yaml)
  - machine-readable catalog
- [canonical/ARTIFACT_PLACEMENT.md](/workspace/vendor/agent-canon/agents/canonical/ARTIFACT_PLACEMENT.md)
  - task 文書と run artifact の置き分け
- [canonical/CLI_ENTRYPOINTS.md](/workspace/vendor/agent-canon/agents/canonical/CLI_ENTRYPOINTS.md)
  - agent ごとの入口差分と bootstrap 入口
- [canonical/CODEX_WORKFLOW.md](/workspace/vendor/agent-canon/agents/canonical/CODEX_WORKFLOW.md)
  - Codex の標準 task 実行フロー
- [canonical/CODEX_SUBAGENTS.md](/workspace/vendor/agent-canon/agents/canonical/CODEX_SUBAGENTS.md)
  - Codex の subagent routing
- [skills/README.md](/workspace/vendor/agent-canon/agents/skills/README.md)
  - 人間向け skill 正本
- [skills/catalog.yaml](/workspace/vendor/agent-canon/agents/skills/catalog.yaml)
  - skill family の機械可読カタログ
- [skills/literature-survey.md](/workspace/vendor/agent-canon/agents/skills/literature-survey.md)
  - 文献調査と先行研究整理の入口
- [skills/research-workflow.md](/workspace/vendor/agent-canon/agents/skills/research-workflow.md)
  - 研究系変更の outer loop
- [skills/adaptive-improvement-loop.md](/workspace/vendor/agent-canon/agents/skills/adaptive-improvement-loop.md)
  - 実験、調査、チューニング、比較改良の outer loop
- [skills/worktree-start.md](/workspace/vendor/agent-canon/agents/skills/worktree-start.md)
  - worktree kickoff、scope 初期化、action log 起点の固定
- [skills/long-form-writing.md](/workspace/vendor/agent-canon/agents/skills/long-form-writing.md)
  - README、workflow、guide などの長文作成フロー
- [skills/academic-writing.md](/workspace/vendor/agent-canon/agents/skills/academic-writing.md)
  - 論文、thesis chapter、scholarly note の作成フロー
- [skills/comprehensive-development.md](/workspace/vendor/agent-canon/agents/skills/comprehensive-development.md)
  - 包括的 repo-wide delivery の umbrella workflow
- [skills/environment-maintenance.md](/workspace/vendor/agent-canon/agents/skills/environment-maintenance.md)
