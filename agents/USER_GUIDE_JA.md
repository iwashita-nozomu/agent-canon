...
- 小規模な repo-changing 差分では `small-change-routing` を使い、選択済み runtime `SKILL.md` の本文読了を selected_runtime_skill_read として扱い、small_change_skill_read、skill 名、path を evidence に残します。
