...
- branch/worktree 作成 route は `repository-topic-clone` の checkout-mode、[agents/canonical/CODEX_INTAKE.md](../canonical/CODEX_INTAKE.md) の Branch Reuse Default、PreToolUse safety owner `tools/runtime/authority/hook_safety.py` を正本にします。
