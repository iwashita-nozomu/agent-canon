...
1. `python3 tools/agent_tools/worktree_scope_lint.py --current` を流し、scope 文書の placeholder と stale field を拾います。
...
1. `bash tools/docs/check_worktree_scopes.sh` で repo 内の worktree scope 配置を確認します。
