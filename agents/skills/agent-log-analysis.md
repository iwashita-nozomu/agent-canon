...
1. 原則として `agent-runtime-compact.md` だけを読み、machine summary、priority problems、next actions、selection misses、evidence drilldown を分析します。
...
- Full dashboard は human review 用です。agent の通常分析入力は compact summary と generated drilldown を既定にします。
