...
| --- | --- | --- |
| `archive_hygiene` | dirty archive, foreign repo-key tree, unreadable result, malformed accumulation | [documents/runtime/runtime-log-archive.md](../../documents/runtime/runtime-log-archive.md), `runtime_log_archive_git.py`, `result-artifact-writeout` |
