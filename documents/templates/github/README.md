...
upstream design ../../operations/issue-label-taxonomy.md issue taxonomy and routing contract.
...
downstream implementation ../../runtime/shared-runtime-surfaces.toml source-to-target projection manifest.
@dependency-end
-->
...
projectionです。`documents/templates/github/` と `.github/` の間に手作業の duplicate
