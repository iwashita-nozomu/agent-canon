...
研究の問い、数式、比較設計、段階的改造の手順は [agents/skills/research-workflow.md](../../../agents/skills/research-workflow.md) を正本とします。
...
- 境界: 研究の問いや比較設計の workflow は
  [agents/skills/research-workflow.md](../../../agents/skills/research-workflow.md) が正本です。
...
- server 実行では、`tools/experiments/execution/run_managed_experiment.py` のような wrapper で host / command / commit metadata を残すことを推奨します。
