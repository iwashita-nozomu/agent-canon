...
- `pyright` とあわせて `python3 tools/validation/semantic/code/check_static_any.py` を通し、明示的な `typing.Any` を repo-wide に禁止します。
...
- baseline 全体: `pyright`
- 明示 `Any` 禁止: `python3 tools/validation/semantic/code/check_static_any.py`
