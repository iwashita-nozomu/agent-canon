...
| ステップ | 内容 | 詳細 |
|---|---|---|
| 1 | 対象範囲を確認 | [01_scope.md](python/01_scope.md) |
| 2 | 公開境界の型注釈を決める | [04_type_annotations.md](python/04_type_annotations.md) |
| 3 | アルゴリズム境界を決める | [algorithm-implementation-boundary.md](../design/algorithm-implementation-boundary.md) |
...
1. [対象](python/01_scope.md)
2. [関数の型注釈](python/04_type_annotations.md)
3. [コメント](python/06_comments.md)
4. [型チェッカの活用](python/07_type_checker.md)
5. [責務分離](python/09_file_roles.md)
6. [アルゴリズム境界](../design/algorithm-implementation-boundary.md)
7. [OOP 境界](./object-oriented-design.md)
8. [命名規約](python/11_naming.md)
9. テスト規約（共通）: [coding-conventions-testing.md](./coding-conventions-testing.md)
10. JAX 補足が必要な場合だけ: [15_jax_rules.md](python/15_jax_rules.md)
11. ベンチマーク方針: [20_benchmark_policy.md](python/20_benchmark_policy.md)
12. 実験ディレクトリ構成: [30_experiment_directory_structure.md](python/30_experiment_directory_structure.md)
