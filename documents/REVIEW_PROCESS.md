...
1. 数式、擬似コード、仕様記述、method contract を伴う task では detailed design review か checkpoint review で、implementation がどの式・仕様項目に対応するかを artifact に固定し、runtime success だけを acceptance 根拠にしないことを確認します。
