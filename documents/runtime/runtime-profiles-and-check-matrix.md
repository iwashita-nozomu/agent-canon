...
| agent-runtime | Agent runtime | `AGENTS.md`, `.codex/config.toml`, `.codex/agents`, `tools/agent-canon`, other project-owned `agents/`, `.agents/`, `.codex/`, and `tools/` content remains separate | An agent performs or reviews repo work | no |
