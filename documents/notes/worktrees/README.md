...
- 追記は `python3 tools/runtime/archive/work_log.py --kind <kind> --message "<what changed>" --next "<next>"` を既定にします。`WORKTREE_SCOPE.md` に contract path が入っていれば、同じ command で run bundle `work_log.md` も更新されます。
