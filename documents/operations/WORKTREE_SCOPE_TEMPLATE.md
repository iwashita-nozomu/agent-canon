...
- [documents/operations/worktree-lifecycle.md](worktree-lifecycle.md)
- [documents/operations/notes-lifecycle.md](notes-lifecycle.md)
- [documents/conventions/coding-conventions-project.md](../conventions/coding-conventions-project.md)
...
- `documents/notes/<existing_context>.md`
- `reports/agents/<run-id>/<artifact>.md`
- broad directory 名だけで済ませず、先に読む file を明記する

## Main Carry-Over Targets

- `documents/notes/worktrees/worktree_<topic>_YYYY-MM-DD.md`
- `documents/notes/experiments/<topic>.md`
- `documents/notes/experiments/results/<topic>_<date>.json`
- `documents/notes/branches/<branch_topic>.md`

## Working Notes During Execution

- Action log path: `documents/notes/worktrees/worktree_<topic>_YYYY-MM-DD.md`
