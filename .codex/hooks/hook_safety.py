...
# upstream implementation ./prompt_secret_guard.py and ./branch_worktree_guard.py expose standalone compatibility wrappers.
...
# @dependency-end
"""Pure safety leaves shared by the active dispatcher and standalone wrappers."""
