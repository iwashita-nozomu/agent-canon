...
| `documents/BRANCH_SCOPE.md`, `agents/workflows/main-integration-workflow.md`, `agents/workflows/agent-canon-pr-workflow.md` | document explicit OID/refspec or clean true-clone route and no cleanup authority | V8-P1 | branch/main/PR owner review |
...
| `documents/REVIEW_PROCESS.md`, `agents/templates/change_review.md`, `agents/templates/final_review.md`, `agents/templates/closeout_gate.md` | review all five v8 findings and reject missing artifact/readback/checkout/terminal/dependency/source-identity evidence | all v8 | independent review and closeout |
