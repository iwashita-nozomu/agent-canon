...
| search, read scope, and reuse survey | deterministic coordinated search via semantic-index and search.py, dependency review artifacts | `search.py`; `run_repo_dependency_review.sh`; bounded search artifacts |
