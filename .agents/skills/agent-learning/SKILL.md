...
@dependency-start
contract reference
upstream implementation ../../../agents/skills/agent-learning.md
@dependency-end
-->
...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill agent-learning --format text`; schema `skill_tool_commands.v2`, digest: `67315c755e9f80cd7fbec3cbc876482fc1ea0d58e46e56bc6bf0b746bba93472`.
