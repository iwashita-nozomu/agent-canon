...
1. Select this skill for user / reviewer feedback about agent behavior, repeated misses, recurrence prevention, "こういう止まり方", task retrospectives, or agent-side memory updates.
