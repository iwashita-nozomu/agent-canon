...
1. For low-risk implementation slices derived from the Abstract Design Frame and design trace, use `spark_worker` first and `worker` as fallback; keep requirements, design, review, and scope judgment off Spark.
