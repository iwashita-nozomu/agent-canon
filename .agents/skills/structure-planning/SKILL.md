...
@dependency-start
contract reference
upstream implementation ../../../agents/skills/structure-planning.md
@dependency-end
-->
...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill structure-planning --format text`; schema `skill_tool_commands.v2`, digest: `36788f30e40876917492cb0fd059b3a1b150ed0d617b8f1f8872b31e2e93a155`.
