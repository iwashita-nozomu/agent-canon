...
upstream implementation ../../../agents/skills/test-design.md canonical-owner
...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill test-design --format text`.
Packet schema: `skill_tool_commands.v2`; packet digest: `2fb5ea1fc782726bef51e7b4ddd0143f9a4cfee68b9b08fee834eeb169bf963f`.
