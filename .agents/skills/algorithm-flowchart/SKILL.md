...
<!-- host-config: path=../.agents/skills/algorithm-flowchart/SKILL.md index=9 order=9 enabled=true digest=02b2baf03a2bc0e580dc2c762c2f9d4951bd85e9a2b62c0ecac865dc496859a7 -->
<!-- toolcalls: tools/agent_tools/agent_team.py#materialize_skill_tool_call_token digest=8535b11fd24fe234d094446258825a1f45021f6201c4f0920042d65346c80458 -->
<!-- materializer: skill_shim_materializer.v1 -->

<!--
@dependency-start
contract reference
upstream implementation ../../../agents/skills/algorithm-flowchart.md
@dependency-end
-->
