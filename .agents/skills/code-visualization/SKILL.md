...
@dependency-start
contract reference
upstream implementation ../../../agents/skills/code-visualization.md
@dependency-end
-->
...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill code-visualization --format text`; schema `skill_tool_commands.v2`, digest: `eef8b9f1f9446631c5c1e30c02d95713654c18bcec830c11af78333d64cd8273`.
