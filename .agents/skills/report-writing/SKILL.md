...
1. Record closeout tokens: `report_writing=complete`, `report_quality_checklist=pass|fail`, `report_source_packet=<path-or-inline>`, `report_reviewer=<path|not_required>`, and `report_rule_drift=<none|canonical_update_required>`.
