...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill agent-update-branch --format text`; schema `skill_tool_commands.v2`, digest: `78558eac85561771c228636232fa966edb4563c09e8f8dd5db6bcaca5cd0392f`.
