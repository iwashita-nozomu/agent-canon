...
@dependency-start
contract reference
upstream implementation ../../../agents/skills/python-review.md
@dependency-end
-->
...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill python-review --format text`; schema `skill_tool_commands.v2`, digest: `31bf2ace6f4bc5b1f786d9e0ee7eaf12d880d98fadd8e04bc497214c5c253ab8`.
