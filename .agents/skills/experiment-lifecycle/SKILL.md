...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill experiment-lifecycle --format text`; schema `skill_tool_commands.v2`, digest: `78d5fe86b6f2e41b342e9b1ff747712814d7efac6892e7b989261e4b239b5a9a`.
