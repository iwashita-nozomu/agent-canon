...
@dependency-start
contract reference
upstream implementation ../../../agents/skills/long-form-writing.md
@dependency-end
-->
...
Read-only command packet: `python3 tools/agent_tools/skill_tool_commands.py show --skill long-form-writing --format text`; schema `skill_tool_commands.v2`, digest: `2378048e96e4f2b1e745c3f5feba55fe20af7b6b5355f4b10478c7e137a0348c`.
