...
`.github/AGENTS.override.md`, then [.github/AGENTS.md](AGENTS.md), then fallback names
...
- human canonical hub: [/agents/README.md](../agents/README.md)
...
- standalone AgentCanon PR checklist: [/.github/PULL_REQUEST_TEMPLATE.md](PULL_REQUEST_TEMPLATE.md)
