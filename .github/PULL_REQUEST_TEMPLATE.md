...
upstream design ../documents/templates/github/README.md defines canonical GitHub template sources and projection boundaries
...
downstream design ../documents/templates/github/pull-request/agent_canon.md owns the template-side canonical source
@dependency-end
-->
